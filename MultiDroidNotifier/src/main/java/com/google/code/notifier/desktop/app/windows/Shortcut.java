/***************************************************************************
 *   Copyright (C) 2009 by Piotr Kopec                                     *
 ...
 ***************************************************************************/
package com.google.code.notifier.desktop.app.windows;
...
public class Shortcut {
	...
	static final int FLV_RAM_DRIVE = 0;// Ram drive (Shortcuts to stuff on a ram drive)
	...
	static FileLocationInfo parseFileLocationInfo(byte[] buff, int offset)
		...
		if ((fli.flags & FF_LOCAL) > 0) {
			...
			lvt.volumeLabel = new String(subarray(buff, offset + 0x2C,
					lvt.length - 0x10 -1));
			//System.out.println("volumeLabel: " + lvt.volumeLabel);
			fli.lvt = lvt;
			fli.basePathName = new String(subarray(buff, offset + fli.offLBP,
					fli.length - fli.offLBP-2));
			//System.out.println(hexDump(subarray(buff, offset+0x1C, lvt.length)));
			//System.out.println(hexDump(lvt.getBytes()));
			//if(byteMatch(lvt.getBytes(),buff,offset+0x1C))
			...
			// System.out.println(nvt.unknown0+" "+nvt.unknown1+" "+Integer.toHexString(nvt.unknown2)+" "+(nvt.length));
			// System.out.println(Integer.toHexString(fli.offNVI));
			// System.out.println(asciiDump(subarray(buff,
			// offset+fli.offNVI+nvt.offNS, nvt.length-0x14)));
			nvt.shareName = new String(subarray(buff, offset + fli.offNVI
					+ nvt.offNS, nvt.length - 0x14-nvt.unknown0-1));
			// System.out.println("shareName: "+nvt.shareName);
			if (nvt.unknown1 > 0) {
				nvt.localShareMapping = new String(subarray(buff, offset
						+ fli.offNVI + nvt.unknown1, nvt.unknown0-1));
				// System.out.println("mappedDisc: "+nvt.localShareMapping);
			}
			fli.nvt = nvt;
			// System.out.println(hexDump(subarray(buff, offset+fli.offNVI,
			// nvt.length)));
			// System.out.println(hexDump(nvt.getBytes()));
			//System.out.println(asciiDump(subarray(buff, offset + fli.offNVI,	nvt.length)));
			//nvt.localShareMapping = "F:";
			//System.out.println(asciiDump(nvt.getBytes()));
		} else
		...
		// System.out.println("fli.rpathName off:"+Integer.toHexString(fli.offRPN+offset));
		//System.out.println("fli.baseathName"+fli.basePathName);
		/*System.out.println("fli.rpathName:" + fli.remainingPathName);
		System.out.println(hexDump(subarray(buff, offset, fli.length)));
		System.out.println(hexDump(fli.getBytes()));
		System.out.println(asciiDump(subarray(buff, offset, fli.length)));
		System.out.println(asciiDump(fli.getBytes()));
		*/
	...
	static public Shortcut loadShortcut(File shortcutFile) throws IOException,
		...
		if ((scut.flags & F_LOCATION) > 0) {
			 ...
			 * System.out.println("file location " + asciiDump(subarray(buff,
			 * offset, len))); System.out.println("file location " +
			 * hexDump(subarray(buff, offset, len)));
			 */
			offset += len;
		}
		...
		/*
		System.out.println(describeShowWnd(scut.showWnd));
		System.out.println(new Date(scut.aTime).toString());
		System.out.println(asciiDump(buff));//subarray(buff, 0, 30)));
		System.out.println(asciiDump(scut.getBytes()));
		*/
		return scut;
	}
...
//				int unknown1 = 0;
	 ...
	 */
	//a0.txt
//0x00#	0x32, 0x00, 0x00, 0x00, 0x00, 0x00, 0xA4, 0x3A,
//0x08#	/*fh, can be null*/0xF7, 0x7D/*!fh*/, 0x20, 0x00, /*filename'a0.txt'*/0x61, 0x30, 0x2E, 0x74,
//0x10#	0x78, 0x74/*!fn*/, 0x00, 0x00/*eof buffer, constant length field*/, 0x24/*some kind of counter, on a10.txt its 0x26*/,0x00, 0x03, 0x00,
//0x18#	0x04, 0x00, 0xEF, 0xBE, 0xA4, 0x3A,/*fh*/0xF7, 0x7D/*!fh*/,
//0x20#	0xA4, 0x3A, /*fh*/0xF7, 0x7D/*!fh*/ , 0x14, 0x00, 0x00, 0x00,
//0x28#	/*filename unicode*/0x61, 0x00, 0x30, 0x00, 0x2E, 0x00, 0x74, 0x00,
//0x30#	0x78, 0x00, 0x74, 0x00/*!fn*/, 0x00, 0x00, 0x16, 0x00}; 
	static final short[] _shit0DesktopI = new short[]{
		0x32, 0x00, 0x00, 0x00, 0x00, 0x00, 0xA4, 0x3A,
		/*fh, can be null*/0xF7, 0x7D/*!fh*/, 0x20, 0x00, /*filename'a0.txt'*/0x61, 0x30, 0x2E, 0x74,
		0x78, 0x74/*!fn*/, 0x00, 0x00/*eof buffer, constant length field*/, 0x24/*some kind of counter, on a10.txt its 0x26*/,0x00, 0x03, 0x00,
		0x04, 0x00, 0xEF, 0xBE, 0xA4, 0x3A,/*fh*/0xF7, 0x7D/*!fh*/,
		0xA4, 0x3A, /*fh*/0xF7, 0x7D/*!fh*/ , 0x14, 0x00, 0x00, 0x00,
		/*filename unicode*/0x61, 0x00, 0x30, 0x00, 0x2E, 0x00, 0x74, 0x00,
		0x78, 0x00, 0x74, 0x00/*!fn*/, 0x00, 0x00, 0x16, 0x00};
	
	static final short[] _shit0DesktopI0 = new short[]{
		0x32, 0x00, 0x00, 0x00, 0x00, 0x00, 0xA4, 0x3A,
		/*fh, can be null*/0x00, 0x00/*!fh*/, 0x20, 0x00, /*filename'a0.txt'*/0x61, 0x30, 0x2E, 0x74,
		0x78, 0x74/*!fn*/, 0x00, 0x00/*eof buffer, constant length field*/, 0x00/*some kind of counter, on a10.txt its 0x26*/,0x00, 0x03, 0x00,
		0x04, 0x00, 0xEF, 0xBE, 0xA4, 0x3A,/*fh*/0x00, 0x00/*!fh*/,
		0xA4, 0x3A, /*fh*/0x00, 0x00/*!fh*/ , 0x14, 0x00, 0x00, 0x00,
		/*filename unicode*/0x61, 0x00, 0x30, 0x00, 0x2E, 0x00, 0x74, 0x00,
		0x78, 0x00, 0x74, 0x00/*!fn*/, 0x00, 0x00, 0x16, 0x00}; 
	//kaper-d.exe
	static final short[] _shit1Desktop0 = new short[]{
		0x32, 0x00, 0x00, 0x30, 0x4F, 0x00, 0x2A, 0x3A,
		0x0D, 0x83, 0x20, 0x00, 0x6B, 0x61, 0x70, 0x65,
		0x72, 0x2D, 0x64, 0x2E, 0x65, 0x78, 0x65, 0x00,
		0x2E, 0x00, 0x03, 0x00, 0x04, 0x00, 0xEF, 0xBE,
		0x2A, 0x3A, 0x0C, 0x83, 0x2A, 0x3A, 0x0C, 0x83,
		0x14, 0x00, 0x00, 0x00, 0x6B, 0x00, 0x61, 0x00,
		0x70, 0x00, 0x65, 0x00, 0x72, 0x00, 0x2D, 0x00,
		0x64, 0x00, 0x2E, 0x00, 0x65, 0x00, 0x78, 0x00,
		0x65, 0x00, 0x00, 0x00, 0x1A, 0x00
	};
	static final short[] _shit1Desktop1 = new short[]{
		0x32, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2A, 0x3A,
		0x00, 0x00, 0x20, 0x00, 0x6B, 0x61, 0x70, 0x65,
		0x72, 0x2D, 0x64, 0x2E, 0x65, 0x78, 0x65, 0x00,
		0x00, 0x00, 0x03, 0x00, 0x04, 0x00, 0xEF, 0xBE,
		0x2A, 0x3A, 0x00, 0x00, 0x2A, 0x3A, 0x00, 0x00,
		0x14, 0x00, 0x00, 0x00, 0x6B, 0x00, 0x61, 0x00,
		0x70, 0x00, 0x65, 0x00, 0x72, 0x00, 0x2D, 0x00,
		0x64, 0x00, 0x2E, 0x00, 0x65, 0x00, 0x78, 0x00,
		0x65, 0x00, 0x00, 0x00, 0x1A, 0x00
	};
	static final short[] _shit1Desktop2 = new short[]{
	...
	/* ka.exe */
	static final short[] _shit2Desktop0 = new short[]{
	0x32, 0x00, 0x00, 0x30, 0x4F, 0x00, 0x2A, 0x3A, 
	0x0D, 0x83, 0x20, 0x00, 0x6B, 0x61, 0x2E, 0x65, 
	0x78, 0x65, 0x00, 0x00, 0x24, 0x00, 0x03, 0x00, 
	0x04, 0x00, 0xEF, 0xBE, 0xA5, 0x3A, 0x27, 0x27, 
	0xA5, 0x3A, 0x27, 0x27, 0x14, 0x00, 0x00, 0x00, 
	0x6B, 0x00, 0x61, 0x00, 0x2E, 0x00, 0x65, 0x00, 
	0x78, 0x00, 0x65, 0x00, 0x00, 0x00, 0x16, 0x00
	};
	static final short[] _shit2Desktop1 = new short[]{
	0x32, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2A, 0x3A, 
	0x00, 0x00, 0x20, 0x00, 0x6B, 0x61, 0x2E, 0x65, 
	0x78, 0x65, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 
	0x04, 0x00, 0xEF, 0xBE, 0xA5, 0x3A, 0x00, 0x00, 
	0xA5, 0x3A, 0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 
	0x6B, 0x00, 0x61, 0x00, 0x2E, 0x00, 0x65, 0x00, 
	0x78, 0x00, 0x65, 0x00, 0x00, 0x00, 0x16, 0x00
	};
	static final short[] _shit2Desktop2 = new short[]{
	0x32, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x20, 0x00, 0x6B, 0x61, 0x2E, 0x65, 
	0x78, 0x65, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 
	0x04, 0x00, 0xEF, 0xBE, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 
	0x6B, 0x00, 0x61, 0x00, 0x2E, 0x00, 0x65, 0x00, 
	0x78, 0x00, 0x65, 0x00, 0x00, 0x00, 0x16, 0x00
	};
//	0x32, 0x00, 0x00, 0x00, 0x00, 0x00, 0xA4, 0x3A, 
//	0x00, 0x00, 0x20, 0x00, 0x61, 0x30, 0x2E, 0x74, 
//	0x78, 0x74, 0x00, 0x00, 0x24, 0x00, 0x03, 0x00, 
//	0x04, 0x00, 0xEF, 0xBE, 0xA4, 0x3A, 0x00, 0x00, 
//	0xA4, 0x3A, 0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 
//	0x61, 0x00, 0x30, 0x00, 0x2E, 0x00, 0x74, 0x00, 
//	0x78, 0x00, 0x74, 0x00, 0x00, 0x00, 0x16, 0x00,
	//kape.exe
	static final short[] _shit3Desktop0 = new short[]{
	0x32, 0x00, 0x00, 0x30, 0x4F, 0x00, 0x2A, 0x3A, 
	0x0D, 0x83, 0x20, 0x00, 0x6B, 0x61, 0x70, 0x65, 
	0x2E, 0x65, 0x78, 0x65, 0x00, 0x00, 0x28, 0x00, 
	0x03, 0x00, 0x04, 0x00, 0xEF, 0xBE, 0xA5, 0x3A, 
	0x00, 0x2A, 0xA5, 0x3A, 0x00, 0x2A, 0x14, 0x00, 
	0x00, 0x00, 0x6B, 0x00, 0x61, 0x00, 0x70, 0x00, 
	0x65, 0x00, 0x2E, 0x00, 0x65, 0x00, 0x78, 0x00, 
	0x65, 0x00, 0x00, 0x00, 0x18, 0x00
	};
	...
	static final short[] _shit3Desktop1 = new short[]{
	0x32, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x20, 0x00, 0x6B, 0x61, 0x70, 0x65, 
	0x2E, 0x65, 0x78, 0x65, 0x00, 0x00, 0x00, 0x00, 
	0x03, 0x00, 0x04, 0x00, 0xEF, 0xBE, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x14, 0x00, 
	0x00, 0x00, 0x6B, 0x00, 0x61, 0x00, 0x70, 0x00, 
	0x65, 0x00, 0x2E, 0x00, 0x65, 0x00, 0x78, 0x00, 
	0x65, 0x00, 0x00, 0x00, 0x00, 0x00
	};
	static final short[] _shit3Desktop2 = new short[]{
	0x32, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x6B, 0x61, 0x70, 0x65, 
	0x2E, 0x65, 0x78, 0x65, 0x00 /*0x00, 0x00, 0x00, 
	0x03, 0x00, 0x04, 0x00, 0xEF, 0xBE, 0x00, 0x00, 
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x00, 0x00, 0x6B, 0x00, 0x61, 0x00, 0x70, 0x00, 
	...
	//kap.exe
	static final short[] _shit4Desktop1 = new short[]{
	0x32, 0x00, 0x00, 0x30, 0x4F, 0x00, 0x2A, 0x3A, 
	0x0D, 0x83, 0x20, 0x00, 0x6B, 0x61, 0x70, 0x2E, 
	0x65, 0x78, 0x65, 0x00, 0x26, 0x00, 0x03, 0x00, 
	0x04, 0x00, 0xEF, 0xBE, 0xA5, 0x3A, 0x65, 0x2B, 
	0xA5, 0x3A, 0x65, 0x2B, 0x14, 0x00, 0x00, 0x00, 
	0x6B, 0x00, 0x61, 0x00, 0x70, 0x00, 0x2E, 0x00, 
	0x65, 0x00, 0x78, 0x00, 0x65, 0x00, 0x00, 0x00, 
	0x16, 0x00 
	};
	//k.exe
	static final short[] _shit5Desktop0 = new short[]{
	0x32, 0x00, 0x00, 0x30, 0x4F, 0x00, 0x2A, 0x3A, 
	0x0D, 0x83, 0x20, 0x00, 0x6B, 0x2E, 0x65, 0x78, 
	0x65, 0x00, 0x22, 0x00, 0x03, 0x00, 0x04, 0x00, 
	0xEF, 0xBE, 0xA5, 0x3A, 0xB1, 0x2B, 0xA5, 0x3A, 
	0xB1, 0x2B, 0x14, 0x00, 0x00, 0x00, 0x6B, 0x00, 
	0x2E, 0x00, 0x65, 0x00, 0x78, 0x00, 0x65, 0x00, 
	0x00, 0x00, 0x14, 0x00
	};
	static final short[] _shit0MyDoc0 = new short[]{
	0x1F, 0x48, 0xBA, 0x8F, 0x0D, 0x45, 0x25, 0xAD, 
	0xD0, 0x11, 0x98, 0xA8, 0x08, 0x00, 0x36, 0x1B, 
	0x11, 0x03
	};
	static final short[] _shit0DeskDir0 = new short[]{
		0x31, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0C, 0x39, 
		0x74, 0x4B, 0x10, 0x00, 0x72, 0x65, 0x67, 0x7A, 
		0x00, 0x00, 0x20, 0x00, 0x03, 0x00, 0x04, 0x00, 
		0xEF, 0xBE, 0x0C, 0x39, 0x5B, 0x4B, 0x0C, 0x39, 
		0x74, 0x4B, 0x14, 0x00, 0x00, 0x00, 0x72, 0x00, 
		0x65, 0x00, 0x67, 0x00, 0x7A, 0x00, 0x00, 0x00, 
		0x14, 0x00
	};
	static final short[] _shit0DeskDir1 = new short[]{
		0x31, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0C, 0x39, 
		0x74, 0x4B, 0x10, 0x00, 0x72, 0x65, 0x67, 0x7A, 
		0x00
	};
	...
	static final short[] _shit0CRoot1A = new short[]{
		0x1F, 0x50, 0xE0, 0x4F, 0xD0, 0x20, 0xEA, 0x3A, 
		0x69, 0x10, 0xA2, 0xD8, 0x08, 0x00, 0x2B, 0x30, 
		0x30, 0x9D
	};
	static final short[] _shit0CRoot0B = new short[]{
		0x2F, 0x43, 0x3A, 0x5C, 0x00, 0x00, 0x00, 0x00, 
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	};
	static final short[] _shit0CRoot1B = new short[]{
		0x2F, 0x43, 0x3A, 0x5C, 0x00
	};
	...
	static final short[] _shit0Unicode0 = new short[]{
		0x32, 0x00, 0x00, 0x00, 0x00, 0x00, 0xA4, 0x3A, 
		0x9D, 0x80, 0x20, 0x00, 0x47, 0x4F, 0x44, 0x39, 
		0x33, 0x31, 0x7E, 0x31, 0x2E, 0x54, 0x58, 0x54, 
		0x00, 0x00, 0x28, 0x00, 0x03, 0x00, 0x04, 0x00, 
		0xEF, 0xBE, 0xA4, 0x3A, 0xE9, 0x85, 0xA4, 0x3A, 
		0xE9, 0x85, 0x14, 0x00, 0x00, 0x00, 0x67, 0x00, 
		0x6F, 0x00, 0x5B, 0x01, 0x07, 0x01, 0x2E, 0x00, 
		0x74, 0x00, 0x78, 0x00, 0x74, 0x00, 0x00, 0x00
	};
	//go??.txt
	static final short[] _shit0Unicode1 = new short[]{
		0x32, 0x00, 0x00, 0x00, 0x00, 0x00, 0xA4, 0x3A, 
		0x9D, 0x80, 0x20, 0x00, 0x67, 0x6F, 0x9C, 0xE6, 
		0x2E, 0x74, 0x78, 0x74, 0x00, 0x00, 0x28, 0x00, 0x03, 0x00, 0x04, 0x00, 
		0xEF, 0xBE, 0xA4, 0x3A, 0xE9, 0x85, 0xA4, 0x3A, 
		0xE9, 0x85, 0x14, 0x00, 0x00, 0x00, 0x67, 0x00, 
		0x6F, 0x00, 0x5B, 0x01, 0x07, 0x01, 0x2E, 0x00, 
		0x74, 0x00, 0x78, 0x00, 0x74, 0x00, 0x00, 0x00
...
/*		Shortcut shortcut = new Shortcut(new File("C:/android/android-notifier-desktop/run.bat"));
		FileOutputStream fos = new FileOutputStream(new File("C:/android/android-notifier-desktop/run.lnk"));
...
*/		// for(String cs:Charset.availableCharsets().keySet())
		...
		*/
		...
		scut.shellItemIDList.add(new ShellItemID(createFileSHID("go??.txt")));
